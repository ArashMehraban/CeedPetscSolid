...
force[i+0*Q] = wJ*((E*nu*y)/((nu*2.0-1.0)*(nu+1.0))+(E*nu*z)/((nu*2.0-1.0)*(nu+1.0))-(E*y*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0)-(E*z*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0));
force[i+1*Q] = wJ*((E*nu*x)/((nu*2.0-1.0)*(nu+1.0))+(E*nu*z)/((nu*2.0-1.0)*(nu+1.0))-(E*x*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0)-(E*z*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0));
force[i+2+Q] = wJ*((E*nu*x)/((nu*2.0-1.0)*(nu+1.0))+(E*nu*y)/((nu*2.0-1.0)*(nu+1.0))-(E*x*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0)-(E*y*(nu-1.0/2.0))/((nu*2.0-1.0)*(nu+1.0)*2.0));
