...
CEED_QFUNCTION(HyperSSdF)(void *ctx, CeedInt Q, const CeedScalar *const *in,
  ...
  for (CeedInt i=0; i<Q; i++) {
    ...
    const CeedScalar dsigma00 = (TwoMu+lambda_bar)*de[0][0] + lambda_bar*de[1][1] +
                                lambda_bar*de[2][2],
                                dsigma11 = lambda_bar*de[0][0] + (TwoMu+lambda_bar)*de[1][1] +
                                           lambda_bar*de[2][2],
                                           dsigma22 = lambda_bar*de[0][0] + lambda_bar*de[1][1] + (TwoMu+lambda_bar)
                                               *de[2][2],
